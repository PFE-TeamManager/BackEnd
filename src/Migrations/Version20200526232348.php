 ...
 */
final class Version20200526232348 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE id_project_id id_project_id INT DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_527EDB25EC92634B ON task (task_title)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_527EDB25EC92634B ON task');
        $this->addSql('ALTER TABLE task CHANGE id_project_id id_project_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE team CHANGE project_id project_id INT DEFAULT NULL');
