 ...
 */
final class Version20200613192320 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task ADD to_do TINYINT(1) DEFAULT NULL, ADD to_do_date DATETIME DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task DROP to_do, DROP to_do_date, CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE team CHANGE project_id project_id INT DEFAULT NULL');
