 ...
 */
final class Version20200516182923 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team ADD updated_at DATETIME NOT NULL, DROP edited_at, CHANGE edited_by edited_by INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team ADD edited_at DATETIME DEFAULT \'NULL\', DROP updated_at, CHANGE edited_by edited_by INT DEFAULT NULL');
