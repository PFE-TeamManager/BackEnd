 ...
 */
final class Version20200526231510 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task ADD enabled TINYINT(1) NOT NULL, CHANGE id_project_id id_project_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task DROP enabled, CHANGE id_project_id id_project_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE team CHANGE project_id project_id INT DEFAULT NULL');
