 ...
 */
final class Version20200608162533 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE labels ADD enabled TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE labels DROP enabled');
        $this->addSql('ALTER TABLE team CHANGE project_id project_id INT DEFAULT NULL');
