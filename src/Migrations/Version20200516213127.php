 ...
 */
final class Version20200516213127 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team DROP created_by, CHANGE edited_by edited_by INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team ADD created_by INT NOT NULL, CHANGE edited_by edited_by INT DEFAULT NULL');
