 ...
 */
final class Version20200516213247 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team DROP edited_by');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team ADD edited_by INT DEFAULT NULL');
